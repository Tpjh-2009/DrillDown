...
public class LoadingScreen extends Scene {
    ...
    protected BitmapFont createFont(FreeTypeFontGenerator gen, float dp) {
        ...
        param.characters += "一上下不与且世业东丝丢两个中串为主么之乏买了事于互五井些交产享亮人什仅从仓仔他以们件价任伐优会传但位低体何余作你使供依侧便保倒值停储像允元充先光入全六共其具养内再写冲况冶冷净准凝几出击分切创初删利到制剂前剩剪割力功加动助势勤匀包化匠区千升单卡即却卸厂压原去叉及双反发取受变叠口另只可台右叶合同名后向吗否含启呀告周命和品哎商喜器回围固图圆土在地场圾均块坚坩垃型垛埃埋城埚域培基堆塑塔填增壮声壳处备复外多够大天太失头夹奇套好如始子字存学它完定宝实室容密察寸对导封将小少尘就尺尽层屏属岩峰巅工左巨己已布希带常幕平并库应底店度建开弃弄式引张弧弯强当录形彼往征待很得循心必志快态思性总恢恭息您情意感慎慢戏成我或户所手才打托扩扭技把折护报抽拆拉拒拖择拽持指按挖换据掘接控推描提摆摘撤支收改放效教数整文斗料断新方施旋无时是显普晶暂曲更最有望木未本术机杂杆材束条来板极构果架某查柱标栋树样核根格档桥桶梯械棒植模次欢止正此步段每比气水永求汇池汽沙没沸油沿泄法泡泥注泵洒洗活流浆浸消涡润液深混温游源滑滚满滤漂漏演激灌火炉炭炸点炼烧热焊焦然煤熔燃爆片版物特状独率玩环现玻珠球理璃生用由电界的盐盖盘目直相看真着知矩石矿码砍砖础硅硫硬确碎碳磁磨磺示离种科秒称移稀程稳空窑立竖端第等筑筒筛简算管箱类粉粗粘精纤级纯纸线组细终经结绕绘绝继续维绿缆缓编缩缺罐网置考者而耐耗联聚胜能脉脚自至致航良色节芯英药获菜萃蒸蓝藏虑融行表被装裹西要覆见观规视角解言计让许论设访识试该语误请诸读调谢谨败质购贴资起超越足车轨转轮软轴载较辅辊输边达过迎运近返还这进远连述退送适选通速造道邻部都配采里重野量金钛钢钮钻铁铅铜银铸链销锁错锚锡锭键锯长门问间阀防阳阵附降限除陶随隧集需青非面音顶项须预题颜额馈馏首验骤高黄黑";
        param.characters += "，。（）“”‘’！？：；《》…—·～午";

        param.packer = new PixmapPacker(2048, 2048, Pixmap.Format.RGBA8888, 1, false);
